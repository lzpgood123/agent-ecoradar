...
Plugin MCP features:
...
lifecycle: at session
...
## MCP installation scopes
...
can be configured
...
three scopes. The scope you
...
in and whether the
...
with your team. Administrators can also
...
servers at the enterprise level
...
...
`.claude/skills/
...
Claude approaches specific tasks
...
"when asked to
...
, use this
...
extend what Claude Code can perceive and act on.
...
...
└── skill-packs/                             ← first-party SKILL.md content
    ├── @claude-code-skills/pack-frontend          shad
...
...
### stdio (Local Process)
...
servers as child processes. Best for local tools and custom servers.
...
...
Title: Claude Skills vs MCP: When CLI+Skills Beats MCP - Verdent Guides
URL: https://www.verdent.ai/guides/claude-skills-vs-mcp
Published: 2026-05-08T09:36:15.000Z
Author: N/A
Highlights:
Most posts settle on a layer model: Skills sit at the prompt or knowledge layer, while MCP sits at the integration layer. That is not wrong. It is just ...
```
