...
. You can
...
-name` to invoke it directly, and Claude can load it automatically when relevant to your conversation. Two front
...
...
...
they provide dynamic capabilities
...
...
...
mcp-filesystem`, `mcp-database`). Each
...
